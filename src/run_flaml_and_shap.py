...
def f_run_flaml_and_shap():
    ...
    # Form and save explainer for the model specified in the config file (lgbm since it performs best out of the three above)
